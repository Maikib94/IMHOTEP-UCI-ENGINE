...
function sanitizeVentilator(partial: Partial<Ventilator>): Partial<Ventilator> {
  ...
  if (partial.pressureSupport !== undefined && isFinite(partial.pressureSupport)) out.pressureSupport = partial.pressureSupport;
  return out;
}
...
export const usePatientStore = create<PatientState>((set) => ({
  ...
  ventilator: { mode: 'VC-AC', fio2: 0.21, vt: 500, peep: 5, setRR: 14, pressureSupport: 10 },
  labOrders: [],
